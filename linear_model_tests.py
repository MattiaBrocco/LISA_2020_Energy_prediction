...
class Test: 
    ...
    def lasso(self, df, X):
        ...
        # Possibility to check for the dataframe of the coefficients
        ...
        y_pred_2 = model_2.predict(X_test_las)

        print("Reducing features with LASSO", "\n\t ## Remaining features:", len(coeffs),
              "\n\t ## R^2 after reduction:", round(r2_score(y_test_las, y_pred_2), 5),
              "\n\t ## MSE after reduction:", round(mean_squared_error(y_test_las, y_pred_2), 5),
              "\n\t ## Variance:", round(np.var(y_pred_2), 5) )
        print()
    ...
    def recurs_elimin(self, df, X, y):
        ...
        # Possibility to check for the dataframe of the features
        ...
        y_pred_rfe = model_rfe.predict(X_tes_rfe)

        print("Reducing features with Recursive Feature Elimination", "\n\t ## Remaining features:", rfecv.n_features_,
              "\n\t ## R^2 after reduction:", round(r2_score(y_tes_rfe, y_pred_rfe), 5),
              "\n\t ## MSE after reduction:", round(mean_squared_error(y_tes_rfe, y_pred_rfe), 5),
              "\n\t ## Variance:", round(np.var(y_pred_rfe), 5) ) 
        print()
        return model_rfe