...
class Tuning:
    ...
    def forest_tun(self):
        ...
        random_grid = {'n_estimators': n_estimators,
                       ...
                       'bootstrap': bootstrap}
        """
        The tuning of the parameters is carried out through the RandomizedSearchCV.
        In the notebook all parameters shown are the best results from RandomizedSearchCV.
